...
/**
 * Unit tests for the {@code GenericArrayType}s created by the {@link GsonTypeChecker} class.
 *
...
public class GenericArrayTypeTest {
  ...
  public void setUp() throws Exception {
    ourType =
        GsonTypeChecker.arrayOf(
            GsonTypeChecker.newParameterizedTypeWithOwner(null, List.class, String.class));
  }

...
/**
 * Unit tests for {@code ParameterizedType}s created by the {@link GsonTypeChecker} class.
 *
...
public class ParameterizedTypeTest {
  ...
  public void setUp() throws Exception {
    ourType = GsonTypeChecker.newParameterizedTypeWithOwner(null, List.class, String.class);
  }
